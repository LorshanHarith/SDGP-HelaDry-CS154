  ...
  Future<void> _sendTemperatureUpdate(String deviceId) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('${AppConfig.baseUrl}/device/update-temperature'),
        headers: {
                      ...
                      children: [
                        Expanded(
                          child: PrimaryButton(
                            ...
                            onPressed: () => _sendTemperatureUpdate(context.read<SessionStore>().activeBatch?['device_id'] ?? ''),
                          ),
                        ),
                        const SizedBox(width: 8),
                        Expanded(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 48,
                    child: OutlinedButton(
                      // We call _sendEmergencyStop here via a wrapper to avoid async return type mismatch or pass params.
